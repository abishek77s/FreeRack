...
import { categories, contentTypeCategories } from './data/categories';
...
function App() {
  ...
  const filteredResources = resources.filter(resource => {
    ...
    const matchesCategory = selectedCategory ? resource.categories.includes(selectedCategory) : true;
    
    // Filter by content type
    const matchesContentType = selectedContentType ? resource.categories.includes(selectedContentType) : true;
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg">No resources found. Try adjusting your search or category filter.</p>
              </div>
            ) : (
